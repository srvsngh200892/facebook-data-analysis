...
class follower_history:
    ...
    def follower_history_method(self,names_list,client,base_url,accesstoken):
        ...
        for user in names_list:
            url = base_url + user 
            url2 = base_url + user + "/insights/page_fans_country?access_token=" + accesstoken
...
class post_details:
     ...
     def post_details_methods(self,names_list,client,base_url):
...
class trending_words:
    ...
    def trends_methods(self,names_list,client,base_url):
        ...
        for handle in names_list:
            url = base_url+ handle + '/posts?access_token=1408129306113261|18650670cff9fb8022dde4b98fc84d3a'
...
class brand_tagging:
    ...
    def brand_tagging_methods(self,names_list,client,base_url):
...
class comment_detail:
    ...
    def comment_details_method(self,names_list,client,base_url):
...
class user_details:
    ...
    def user_details_method(self,names_list,client,base_url):
...
class post_likes_comments:
    ...
    def post_like_method(self,names_list,client,base_url):
...
if __name__ == '__main__':
    ...
    def a():
        ...
        fol_hist.follower_history_method(names_list,client,base_url,accesstoken)
                          
        post_hist=post_details()
        post_hist.post_details_methods(names_list,client,base_url)
        trendss=trending_words()
        trendss.trends_methods(names_list,client,base_url)
        brands=brand_tagging()
        brands.brand_tagging_methods(names_list,client,base_url)
        comment=comment_detail()
        comment.comment_details_method(names_list,client,base_url)
       
        user=user_details()
        user.user_details_method(names_list,client,base_url)
        details=post_likes_comments()
        details.post_like_method(names_list,client,base_url)
